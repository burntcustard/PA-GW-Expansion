define([
    ...
    GWStar.prototype = {
        load: function(config) {
            ...
            //console.log("Loading a system with this AI:");
            //console.log(JSON.stringify(config.ai));
        ...
        save: function(noSystem) {
            ...
            //console.log("Saving a system with this AI:");
            //console.log(JSON.stringify(self.ai));
